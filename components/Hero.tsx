...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden bg-bg text-ink">
      ...
      <div
        ref={skylineRef}
        className="pointer-events-none absolute inset-x-0 bottom-0 h-[260px] text-ink/40"
      >
        <Skyline className="h-full w-full" />
      </div>

      <div className="relative mx-auto w-full max-w-4xl px-6 pt-8 pb-28 lg:px-8">
        ...
        <h1
          ...
          className="mt-5 max-w-[46rem] text-[3.2rem] font-normal leading-[0.94] tracking-tight text-ink sm:text-[4rem] lg:text-[4.6rem] xl:text-[5rem]"
        >
        ...
        <p className="mt-6 max-w-[31rem] font-sans text-[14px] leading-relaxed text-ink/60">
